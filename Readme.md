...
# Parsing + Configuration Script – Decentlab DL-IAM - Rev. A

This **Parsing + Configuration** script is designed for the **Decentlab DL-IAM** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Decentlab DL-IAM Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Decentlab DL-IAM** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
